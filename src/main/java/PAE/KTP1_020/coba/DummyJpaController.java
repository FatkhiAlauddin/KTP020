 ...
 */
package PAE.KTP1_020.coba;

import PAE.KTP1_020.coba.exceptions.NonexistentEntityException;
import PAE.KTP1_020.coba.exceptions.PreexistingEntityException;
...
public class DummyJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("PAE_KTP1_020_jar_0.0.1-SNAPSHOTPU");
